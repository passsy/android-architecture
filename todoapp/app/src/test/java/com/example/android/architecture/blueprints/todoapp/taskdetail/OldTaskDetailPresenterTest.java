...
/**
 * Unit tests for the implementation of {@link OldTaskDetailPresenter}
 */
public class OldTaskDetailPresenterTest {
    ...
    private OldTaskDetailPresenter mOldTaskDetailPresenter;
    ...
    public void getActiveTaskFromRepositoryAndLoadIntoView() {
        ...
        mOldTaskDetailPresenter = new OldTaskDetailPresenter(
                ACTIVE_TASK.getId(), mTasksRepository, mTaskDetailView);
        mOldTaskDetailPresenter.start();
    ...
    public void deleteTask() {
        ...
        mOldTaskDetailPresenter.deleteTask();
    ...
    public void completeTask() {
        ...
        mOldTaskDetailPresenter.completeTask();
    ...
    public void activateTask() {
        ...
        mOldTaskDetailPresenter.activateTask();
    ...
    public void activeTaskIsShownWhenEditing() {
        ...
        mOldTaskDetailPresenter = new OldTaskDetailPresenter(
                ACTIVE_TASK.getId(), mTasksRepository, mTaskDetailView);
        mOldTaskDetailPresenter.editTask();
